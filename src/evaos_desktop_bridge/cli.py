...
def build_parser() -> argparse.ArgumentParser:
    ...
    start_turn_mode = start_turn_parser.add_mutually_exclusive_group()
    start_turn_mode.add_argument("--dry-run", action="store_true", help="Preview without starting a turn.")
    start_turn_mode.add_argument("--live", action="store_true", help="Actually start the turn; requires --confirm and --source-audit-id.")
    ...
    steer_turn_mode = steer_turn_parser.add_mutually_exclusive_group()
    steer_turn_mode.add_argument("--dry-run", action="store_true", help="Preview without steering a turn.")
    steer_turn_mode.add_argument("--live", action="store_true", help="Actually steer the turn; requires --confirm and --source-audit-id.")
    ...
    interrupt_turn_mode = interrupt_turn_parser.add_mutually_exclusive_group()
    interrupt_turn_mode.add_argument("--dry-run", action="store_true", help="Preview without interrupting a turn.")
    interrupt_turn_mode.add_argument("--live", action="store_true", help="Actually interrupt the turn; requires --confirm and --source-audit-id.")
