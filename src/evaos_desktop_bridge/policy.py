...
COMMAND_METADATA: dict[str, dict[str, Any]] = {
    ...
    "customer_mac.iphone_mirroring_scroll": {"mode": "support_canary_guarded_visible_action", "source": "iphone_mirroring_keyboard", "requires_permission": ["accessibility"], "requires_approval": True, "support_only": True, "generic_coordinates": False},
    "customer_mac.iphone_mirroring_swipe_left": {"mode": "support_canary_guarded_visible_action", "source": "iphone_mirroring_keyboard", "requires_permission": ["accessibility"], "requires_approval": True, "support_only": True, "generic_coordinates": False},
    "customer_mac.iphone_mirroring_swipe_right": {"mode": "support_canary_guarded_visible_action", "source": "iphone_mirroring_keyboard", "requires_permission": ["accessibility"], "requires_approval": True, "support_only": True, "generic_coordinates": False},
    "customer_mac.iphone_mirroring_swipe_up": {"mode": "support_canary_guarded_visible_action", "source": "iphone_mirroring_keyboard", "requires_permission": ["accessibility"], "requires_approval": True, "support_only": True, "generic_coordinates": False},
    "customer_mac.iphone_mirroring_swipe_down": {"mode": "support_canary_guarded_visible_action", "source": "iphone_mirroring_keyboard", "requires_permission": ["accessibility"], "requires_approval": True, "support_only": True, "generic_coordinates": False},
    "customer_mac.iphone_mirroring_type_approved_text": {"mode": "support_canary_guarded_visible_action", "source": "iphone_mirroring_keyboard", "requires_permission": ["accessibility"], "requires_approval": True, "support_only": True, "text_scope": "same_turn_approved_text"},
    "customer_mac.iphone_mirroring_send_approved_message": {"mode": "support_canary_guarded_visible_action", "source": "iphone_mirroring_ax", "requires_permission": ["accessibility"], "requires_approval": True, "support_only": True, "message_scope": "same_turn_approved_recipient_and_exact_text"},
