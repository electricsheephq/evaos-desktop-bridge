...
COMMAND_METADATA: dict[str, dict[str, Any]] = {
    ...
    "codex.app_server.start_turn": {"mode": "guarded_remote_control_action", "source": "app_server", "requires_permission": [], "requires_confirmation": True, "requires_source_audit_id": True},
    "codex.app_server.steer_turn": {"mode": "guarded_remote_control_action", "source": "app_server", "requires_permission": [], "requires_confirmation": True, "requires_source_audit_id": True},
    "codex.app_server.interrupt_turn": {"mode": "guarded_remote_control_action", "source": "app_server", "requires_permission": [], "requires_confirmation": True, "requires_source_audit_id": True},
