...
COMMAND_METADATA: dict[str, dict[str, Any]] = {
    ...
    "codex.acpx_list": {"mode": "read_only", "source": "acpx", "requires_permission": []},
    "codex.acpx_show": {"mode": "read_only", "source": "acpx", "requires_permission": []},
    "codex.acpx_status": {"mode": "read_only", "source": "acpx", "requires_permission": []},
    "codex.acpx_prompt": {"mode": "guarded_worker_action", "source": "acpx", "requires_permission": [], "writes_worker": True},
    "codex.acpx_history": {"mode": "read_only", "source": "acpx", "requires_permission": []},
    "codex.acpx_tail_events": {"mode": "read_only", "source": "acpx_stream", "requires_permission": []},
    ...
    "codex.desktop_freshness": {"mode": "read_only", "source": "rollout_vs_visible_text", "requires_permission": []},
    "codex.rehydrate_thread": {"mode": "guarded_visible_action", "source": "deep_link", "requires_permission": []},
    "codex.steer_thread": {"mode": "guarded_thread_action", "source": "codex_exec_resume", "requires_permission": [], "writes_thread": True},
    ...
    "customer_mac.iphone_mirroring_scroll": {"mode": "unsupported_pending_evidence", "source": "iphone_mirroring", "requires_permission": ["accessibility"], "requires_approval": True},
