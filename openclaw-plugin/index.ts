...
function readOnlyTools(): ToolDefinition[] {
  return [
    ...
    tool(
      "desktop_type",
      "Type exact text into the focused Mac field.",
      "desktopType",
      {
        type: "object",
        additionalProperties: false,
    ...
    tool(
      "desktop_drag",
      "Drag from one point to another on the customer's Mac.",
      "desktopDrag",
      {
        type: "object",
        additionalProperties: false,
    ...
    tool(
      "desktop_hotkey",
      "Press a Mac hotkey such as cmd+l, cmd+r, or cmd+shift+4.",
      "desktopHotkey",
      {
        type: "object",
        additionalProperties: false,
    ...
    tool(
      "desktop_focus_app",
      "Focus or open a Mac app by name.",
      "desktopFocusApp",
      {
        type: "object",
        additionalProperties: false,
    ...
    tool(
      "desktop_menu",
      "Choose a visible menu path through Peekaboo, for example File > New Tab.",
      "desktopMenu",
      {
        type: "object",
        additionalProperties: false,
    ...
    tool(
      "iphone_see",
      "See the visible iPhone Mirroring surface through the paired Mac.",
      "iphoneSee",
      {
        type: "object",
        additionalProperties: false,
    ...
    tool(
      "iphone_swipe",
      "Swipe the focused iPhone Mirroring surface.",
      "iphoneSwipe",
      {
        type: "object",
        additionalProperties: false,
    ...
    tool(
      "iphone_type",
      "Type exact text into the focused iPhone Mirroring field.",
      "iphoneType",
      {
        type: "object",
        additionalProperties: false,
