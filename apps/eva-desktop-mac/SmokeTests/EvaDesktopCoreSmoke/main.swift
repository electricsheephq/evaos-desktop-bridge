...
precondition(osViewsSource.contains("canOpenBusinessBrowser: model.isSignedIn && model.canOpenSurface(\"business_browser\")"))
precondition(osViewsSource.contains("canOpenCreativeStudio: model.canOpenSurface(\"creative_studio\")"))
...
precondition(!workbenchModelSource.contains("Your evaOS Workbench session expired or was revoked. Sign in again to open workspaces."))
