...
precondition(AppBrand.runtimeSectionTitle == "Workspaces")
precondition(AppBrand.signedOutStatus == "Sign in to open Eva workspaces")
...
precondition(WorkbenchProviderCatalog.defaultStates.first { $0.key == .googleWorkspace }?.status == .needsLogin)
precondition(WorkbenchProviderCatalog.defaultStates.filter { ![.openAICodex, .googleWorkspace].contains($0.key) }.allSatisfy { $0.status == .planned })
...
precondition(awayNotificationPlan.notifications[0].title == "Needs your okay: gmail.send")
...
precondition(expiringNotificationPlan.notifications[0].title == "Decision expiring: gmail.send")
...
let ownerSurfaces = WorkbenchAgentAssignmentAccessPolicy.visibleSurfaces(for: .owner, assignment: nil)
precondition(ownerSurfaces.contains("connected_apps"))
precondition(ownerSurfaces.contains("company_brain"))
precondition(ownerSurfaces.contains("members"))
precondition(ownerSurfaces.contains("billing"))
precondition(ownerSurfaces.contains("technical_dashboards"))
let managerSurfaces = WorkbenchAgentAssignmentAccessPolicy.visibleSurfaces(for: .manager, assignment: nil)
precondition(managerSurfaces.contains("approvals"))
precondition(managerSurfaces.contains("company_brain"))
precondition(managerSurfaces.contains("business_browser"))
precondition(!managerSurfaces.contains("members"))
precondition(!managerSurfaces.contains("billing"))
precondition(!managerSurfaces.contains("technical_dashboards"))
let memberSurfaces = WorkbenchAgentAssignmentAccessPolicy.visibleSurfaces(for: .member, assignment: nil)
precondition(memberSurfaces.contains("company_brain"))
precondition(memberSurfaces.contains("business_browser"))
precondition(!memberSurfaces.contains("approvals"))
precondition(!memberSurfaces.contains("connected_apps"))
...
precondition(!RuntimeDefinition.visibleRuntimes(canAccessAdminRuntimes: false).contains { $0.key == .openclaw })
precondition(!RuntimeDefinition.visibleRuntimes(canAccessAdminRuntimes: false).contains { $0.key == .hermes })
precondition(!RuntimeDefinition.visibleRuntimes(canAccessAdminRuntimes: false).contains { $0.key == .missionControl })
precondition(!RuntimeDefinition.visibleRuntimes(canAccessAdminRuntimes: false).contains { $0.key == .terminal })
precondition(RuntimeDefinition.visibleRuntimes(canAccessAdminRuntimes: true).contains { $0.key == .openclaw })
...
precondition(RuntimeDefinition.definition(for: .openclaw).requiresAdmin)
precondition(RuntimeDefinition.definition(for: .hermes).requiresAdmin)
precondition(RuntimeDefinition.definition(for: .missionControl).requiresAdmin)
precondition(RuntimeDefinition.definition(for: .terminal).requiresAdmin)
precondition(RuntimeDefinition.definition(for: .openclaw).title == "Eva Workspace")
precondition(RuntimeDefinition.definition(for: .openclaw).technicalDashboardTitle == "OpenClaw Dashboard")
precondition(RuntimeDefinition.definition(for: .hermes).technicalDashboardTitle == "Hermes Dashboard")
...
precondition(contentViewSource.contains("@State private var sidebarSelection: SidebarSelection? = .sessionCenter"))
...
precondition(osViewsSource.contains("When Eva needs permission to send, spend, write"))
precondition(osViewsSource.contains("How Approvals Work"))
...
precondition(osViewsSource.contains("WorkbenchSurface(title: \"Connected Apps\""))
precondition(osViewsSource.contains("Connect the business apps Eva can use"))
...
precondition(osViewsSource.contains("AionReferenceSpikeSection("))
precondition(osViewsSource.contains("struct AionReferenceSpikeSection"))
precondition(osViewsSource.contains("Start Work With Eva"))
precondition(osViewsSource.contains("Pick a starter task and Workbench opens the right app, browser, or approval inbox."))
precondition(osViewsSource.contains("Agent Team"))
precondition(osViewsSource.contains("Task Launcher"))
precondition(osViewsSource.contains("TaskLauncherActionRow"))
precondition(osViewsSource.contains("isSignedIn: model.isSignedIn"))
precondition(osViewsSource.contains("hasBusinessBrowserAccess: model.canOpenSurface(\"business_browser\")"))
precondition(osViewsSource.contains("hasCreativeStudioAccess: model.canOpenSurface(\"creative_studio\")"))
precondition(osViewsSource.contains("requiresSignIn: true"))
precondition(osViewsSource.contains("requiresSignIn: false"))
precondition(osViewsSource.contains("Ask an admin to grant access."))
precondition(osViewsSource.contains("jumpToRuntime(.liveBrowser)"))
precondition(osViewsSource.contains("jumpToRuntime(.creativeStudio)"))
precondition(osViewsSource.contains("RuntimeDefinition.isBrokeredRuntime(runtime) || RuntimeDefinition.externalURL(for: runtime) != nil"))
precondition(osViewsSource.contains("Open hosted Creative Studio"))
precondition(!osViewsSource.contains("Agent Workspace Preview"))
precondition(osViewsSource.contains("Assistant Catalog"))
precondition(osViewsSource.contains("App & Tool Readiness"))
precondition(osViewsSource.contains("Permission Badges"))
...
precondition(!osViewsSource.contains("BrowserWindow"))
precondition(!osViewsSource.contains("nodeIntegration"))
precondition(!osViewsSource.contains("localStorage"))
precondition(!osViewsSource.contains("YOLO"))
precondition(!osViewsSource.contains("Full-Auto"))
precondition(!osViewsSource.contains("OPENAI_API_KEY"))
let swiftPackageSource = try String(contentsOfFile: "Package.swift", encoding: .utf8)
precondition(!swiftPackageSource.contains("AionUi"))
precondition(!swiftPackageSource.contains("Electron"))
precondition(!swiftPackageSource.contains("node"))
let commandCenterADR = try String(contentsOfFile: "../../docs/smb-command-center-v1-architecture.md", encoding: .utf8)
precondition(commandCenterADR.contains("AionUi Keep / Reject Decisions"))
...
precondition(sidebarSource.contains("FeatureSidebarRow(title: \"Approvals\""))
...
precondition(sidebarSource.contains("Section(\"Business Admin\")"))
precondition(sidebarSource.contains("Section(\"Technical Dashboards\")"))
precondition(sidebarSource.contains("FeatureSidebarRow(title: \"Connected Apps\""))
precondition(sidebarSource.contains("FeatureSidebarRow(title: \"People & Access\""))
precondition(sidebarSource.contains("FeatureSidebarRow(title: \"Company Brain\""))
...
precondition(sidebarSource.contains("model.canOpenPeopleAccessDashboard"))
precondition(sidebarSource.contains("model.canOpenCompanyBrainDashboard"))
precondition(sidebarSource.contains("model.visibleWorkspaceRuntimes"))
precondition(sidebarSource.contains("model.visibleTechnicalDashboardRuntimes"))
precondition(sidebarSource.contains("runtime.technicalDashboardTitle"))
...
let businessAdminSection = sidebarSource.range(of: "Section(\"Business Admin\")")!
let technicalDashboardSection = sidebarSource.range(of: "Section(\"Technical Dashboards\")")!
let settingsSection = sidebarSource.range(of: "Section(AppBrand.bridgeSectionTitle)")!
let providersSidebarRow = sidebarSource.range(of: "FeatureSidebarRow(title: \"Connected Apps\"")!
precondition(homeSection.lowerBound < workspaceSection.lowerBound)
precondition(workspaceSection.lowerBound < businessAdminSection.lowerBound)
precondition(businessAdminSection.lowerBound < technicalDashboardSection.lowerBound)
precondition(technicalDashboardSection.lowerBound < settingsSection.lowerBound)
precondition(businessAdminSection.lowerBound < providersSidebarRow.lowerBound)
...
precondition(!runtimeDetailSource.contains("RuntimeStatusStrip(model: model"))
precondition(!runtimeDetailSource.contains("struct RuntimeStatusStrip"))
...
precondition(expansionDoc.contains("Feature rollback disables only the new surface; direct workspace launch remains available"))
...
precondition(expansionDoc.contains("VITE_EVAOS_APPROVAL_CENTER"))
precondition(expansionDoc.contains("No provider, session, or runtime truth is inferred from cached UI state"))
let visibleRestorationDoc = try String(contentsOfFile: "../../docs/visible-smb-feature-restoration-2026-06-02.md", encoding: .utf8)
precondition(visibleRestorationDoc.contains("Desktop sign-in resilience"))
precondition(visibleRestorationDoc.contains("The native SwiftUI Workbench shell is not browser-hostable"))
precondition(visibleRestorationDoc.contains("Business Admin: Connected Apps, People & Access, Company Brain"))
precondition(visibleRestorationDoc.contains("Technical Dashboards: OpenClaw Dashboard, Hermes Dashboard, Mission Control, Terminal"))
let actionableTaskLauncherDoc = try String(contentsOfFile: "../../docs/actionable-task-launcher-2026-06-02.md", encoding: .utf8)
precondition(actionableTaskLauncherDoc.contains("Make Home feel more capable without adding a new unsafe execution surface."))
precondition(actionableTaskLauncherDoc.contains("Email follow-up opens Connected Apps"))
precondition(actionableTaskLauncherDoc.contains("Sales research opens Business Browser"))
precondition(actionableTaskLauncherDoc.contains("Admin inbox opens Approvals"))
precondition(actionableTaskLauncherDoc.contains("Creative brief opens hosted Creative Studio"))
precondition(actionableTaskLauncherDoc.contains("SwiftUI Workbench shell is not browser-hostable"))
...
precondition(creativeStudioDesignGateDoc.contains("https://www.comfy.org/cloud"))
precondition(creativeStudioDesignGateDoc.contains("RuntimeDefinition.externalURL(for: .creativeStudio)"))
...
precondition(creativeStudioDesignGateDoc.contains("visible in Workbench as a hosted web workspace"))
...
precondition(workbenchModelSource.contains("func openPeopleAccessDashboard()"))
precondition(workbenchModelSource.contains("dashboard/invites"))
precondition(workbenchModelSource.contains("visibleWorkspaceRuntimes"))
precondition(workbenchModelSource.contains("visibleTechnicalDashboardRuntimes"))
precondition(workbenchModelSource.contains("isSignedIn && canOpenSurface(\"members\")"))
precondition(workbenchModelSource.contains("isSignedIn && canOpenSurface(\"company_brain\")"))
precondition(workbenchModelSource.contains("Sign-in succeeded, but account permissions could not load."))
precondition(workbenchModelSource.contains("Account permissions unavailable. Refresh or sign out and back in if this persists."))
precondition(workbenchModelSource.contains("Account permissions unavailable for this workspace. Refresh or sign out and back in if this persists."))
let runtimeAuthDegradeStart = workbenchModelSource.range(of: "private func degradeRuntimeAuthorization")!
let runtimeAuthDegradeEnd = workbenchModelSource.range(of: "private func applyBusinessBrowserStatus")!
let runtimeAuthDegradeSource = String(workbenchModelSource[runtimeAuthDegradeStart.lowerBound..<runtimeAuthDegradeEnd.lowerBound])
precondition(runtimeAuthDegradeSource.contains("runtimeStatuses[runtime] = nil"))
...
precondition(workbenchModelSource.contains("openDashboardHandoff(pathComponent: \"dashboard/company-brain\""))
...
precondition(!workbenchModelSource.contains("definition.key != .creativeStudio || featureFlags.isEnabled(.creativeStudio)"))
...
precondition(workbenchModelSource.contains("providerDashboardURL(providerKey: providerKey)"))
...
precondition(workbenchModelSource.contains("Opening Business Browser for app sign-in"))
precondition(workbenchModelSource.contains("business browser"))
...
precondition(workbenchModelSource.contains("capabilityManifestStatusText = \"Ready: \\(summary.totalGrantCount) permissions\""))
...
let newerManifest = WorkbenchReleaseManifest(version: AppBrand.version, build: "1", downloadURL: trustedDownload)
let nextBuildNumber = String((Int(AppBrand.buildNumber) ?? 0) + 1)
let newerBuildManifest = WorkbenchReleaseManifest(version: AppBrand.version, build: nextBuildNumber, downloadURL: trustedDownload)
...
try WorkbenchUpdateClient.validate(WorkbenchReleaseManifest(version: AppBrand.version, build: AppBrand.buildNumber, downloadURL: trustedDownload, sha256: String(repeating: "a", count: 64), releaseNotesURL: URL(string: "https://www.electricsheephq.com/evaos-workbench")!))
...
precondition(osViewsSource.contains("What Eva Can Access"))
...
precondition(decodedRuntimeStatus.currentURLSummary?.host == "example.com")
precondition(decodedRuntimeStatus.currentURLSummary?.path == "/path")
precondition(decodedRuntimeStatus.currentURLSummary?.queryRedacted == true)
...
let browserStatusResponse = """
{"schema_version":"evaos.browser_status.v1","customer_account_id":"acct-1","customer_id":"david-poku","runtime":"browser","status":"ready","room_id":"shared-browser:david-poku","session_id":"browser-session-1","owner":"david-poku","current_url":{"host":"accounts.google.com","path":"/signin","query_redacted":true},"last_activity_at":"2026-06-01T00:00:00Z","needs_auth":true,"needs_captcha":false,"actions":["start_attach","future_action","refresh_status","stop_browser"],"source_pointer":"broker:runtime_status:browser","audit_id":"audit-browser-1"}
""".data(using: .utf8)!
let decodedBrowserRuntimeStatus = try EvaDesktopISO8601.decoder().decode(RuntimeStatusResponse.self, from: browserStatusResponse)
precondition(decodedBrowserRuntimeStatus.schemaVersion == "evaos.browser_status.v1")
precondition(decodedBrowserRuntimeStatus.customerAccountID == "acct-1")
precondition(decodedBrowserRuntimeStatus.customerID == "david-poku")
precondition(decodedBrowserRuntimeStatus.runtimeKey == .liveBrowser)
precondition(decodedBrowserRuntimeStatus.displayLabel == "Business Browser")
precondition(decodedBrowserRuntimeStatus.roomId == "shared-browser:david-poku")
precondition(decodedBrowserRuntimeStatus.sessionID == "browser-session-1")
precondition(decodedBrowserRuntimeStatus.authNeeded == true)
precondition(decodedBrowserRuntimeStatus.captchaNeeded == false)
...
precondition(browserStatusContract.customerID == "david-poku")
precondition(browserStatusContract.runtime == .liveBrowser)
precondition(browserStatusContract.roomID == "shared-browser:david-poku")
precondition(browserStatusContract.sessionID == "browser-session-1")
precondition(browserStatusContract.needsAuth == true)
precondition(browserStatusContract.needsCaptcha == false)
precondition(browserStatusContract.currentURL?.host == "accounts.google.com")
precondition(browserStatusContract.currentURL?.queryRedacted == true)
...
precondition(degradedMissionCard.nextAction.contains("needs sign-in"))
...
precondition(creativeRuntimeRecord.resumeRoute.kind == .evidenceOnly)
precondition(WorkbenchSessionContract.brokerRuntimeToOpen(for: creativeRuntimeRecord) == nil)
...
precondition(recentLaunch.title == "Business Browser")
precondition(recentLaunch.status == "Restorable")
precondition(recentLaunch.sourcePointer == "broker:runtime_status:browser")
precondition(recentLaunch.nextAction == "Open this workspace again.")
precondition(recentLaunch.details.contains("Saved shortcut"))
...
precondition(recentSessionRecord.nextAction == "Open this workspace again.")
...
precondition(workbenchModelSource.contains("RuntimeDefinition.isBrokeredRuntime(runtime) || RuntimeDefinition.externalURL(for: runtime) != nil"))
...
precondition(customerObserverSource.contains("businessBrowserStatus = nil"))
...
precondition(workbenchOSViewsSource.contains("BusinessBrowserQuickActionCard"))
precondition(workbenchOSViewsSource.contains("businessBrowserStatus: model.businessBrowserStatus"))
precondition(workbenchOSViewsSource.contains("browserRoomText: model.sharedBrowserRoomText"))
precondition(workbenchOSViewsSource.contains("browserCurrentURLText: model.sharedBrowserCurrentURLText"))
precondition(workbenchOSViewsSource.contains("fallbackRoomText: browserRoomText"))
precondition(workbenchOSViewsSource.contains("fallbackCurrentURLText: browserCurrentURLText"))
precondition(workbenchOSViewsSource.contains("Sign in to start the browser Eva uses"))
precondition(workbenchOSViewsSource.contains("A website in Business Browser needs CAPTCHA"))
precondition(workbenchOSViewsSource.contains("Start / Attach"))
precondition(workbenchOSViewsSource.contains("Room"))
precondition(workbenchOSViewsSource.contains("Last activity"))
precondition(!workbenchOSViewsSource.contains("Open business browser"))
precondition(!workbenchOSViewsSource.contains("Use the shared browser for sign-ins"))
let resetRuntimeStart = workbenchModelSource.range(of: "private func resetRuntime(_ runtime: RuntimeKey)")!
let resetRuntimeEnd = workbenchModelSource.range(of: "private func resetRuntimeWebViewIfNeeded")!
let resetRuntimeSource = String(workbenchModelSource[resetRuntimeStart.lowerBound..<resetRuntimeEnd.lowerBound])
precondition(resetRuntimeSource.contains("if runtime == .liveBrowser"))
precondition(resetRuntimeSource.contains("runtimeStatuses[runtime] = nil"))
precondition(resetRuntimeSource.contains("businessBrowserStatus = nil"))
