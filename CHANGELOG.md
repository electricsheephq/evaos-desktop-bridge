...
- Replace CodeQL default setup with advanced, path-gated CodeQL workflows for issue #159: Linux scans cover Actions/Python/JavaScript on relevant PRs, Swift CodeQL is limited to Swift/workflow PRs plus main/scheduled/manual runs, and PR runs cancel superseded pushes.
